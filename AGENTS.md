...
- **AI Providers**: Google Gemini Flash (default free tier), Anthropic Codex Haiku, OpenAI GPT-4o mini
...
- BYOK users → their encrypted API key + preferred provider (Gemini / Codex / OpenAI)
...
4. **`ProvidersModule`** — adapters for Gemini Flash, Codex Haiku, GPT-4o mini; each implements `AIProvider`
