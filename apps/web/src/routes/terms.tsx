        ...
        <div className='space-y-8 text-zinc-300 leading-relaxed'>
          ...
          <Section title='4. Acceptable use'>
            ...
            <ul className='list-disc list-inside space-y-1 text-zinc-400'>
              ...
              <li>Share your API key or account credentials with others</li>
              <li>
          ...
          <Section title='6. Free tier limits'>
            <p>
              Free accounts are limited to 10 generations per day per generation
              type. We reserve the right to adjust these limits. We will notify
          ...
          <Section title='9. Disclaimers and limitation of liability'>
            <p>
              GitPilot is provided "as is" without warranty of any kind, express
